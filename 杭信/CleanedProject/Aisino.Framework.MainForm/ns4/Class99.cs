namespace ns4
{
    ...
    internal class Class99
    {
        ...
        {
            this.uint_2 ^= uint_0;
            this.uint_2 = uint_1[(int) ((IntPtr) ((ulong)(this.uint_2 ^ int_0) & ((ulong) 0xffL)))] ^ (this.uint_2 >> 8);
            this.uint_2 ^= uint_0;
        }

        public void method_4(byte[] byte_0)
        {
            this.method_5(byte_0, 0, byte_0.Length);
        }
        ...
        public void method_5(byte[] byte_0, int int_0, int int_1)
        {
            ...
            while (--int_1 >= 0)
            {
                this.uint_2 = uint_1[(int) ((IntPtr) ((this.uint_2 ^ byte_0[int_0++]) & 0xff))] ^ (this.uint_2 >> 8);
            }
            this.uint_2 ^= uint_0;
        }

        public static uint smethod_0(Stream stream_0)
        {
            if (stream_0 == null)
            {
            ...
            int num = 0;
            while ((num = stream_0.Read(buffer, 0, buffer.Length)) != 0)
            {
                class2.method_5(buffer, 0, num);
            }
            stream_0.Position = 0L;
        ...
        public static uint smethod_1(string string_0)
        {
            ...
            byte[] buffer = new byte[0x1000];
            int num = 0;
            using (FileStream stream = new FileStream(string_0, FileMode.OpenOrCreate))
            {
