namespace Aisino.Fwkp.Bsgl
{
    ...
    public class FPProgressBar : BaseForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.xmlComponentLoader1.set_XMLPath("");
            this.label_Tip.AutoSize = true;
            this.label_Tip.Font = new Font("微软雅黑", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0x86);
            this.label_Tip.Location = new Point(0x16d, 0x5f);
            this.label_Tip.Name = "label_Tip";
            this.label_Tip.Size = new Size(100, 0x13);
            this.label_Tip.TabIndex = 1;
            this.label_Tip.Text = "请等待任务完成";
            this.label_Title.AutoSize = true;
            this.label_Title.Font = new Font("微软雅黑", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0x86);
            this.label_Title.Location = new Point(0x17, 0x25);
            this.label_Title.Name = "label_Title";
            this.label_Title.Size = new Size(0x8b, 0x13);
            this.label_Title.TabIndex = 1;
            this.label_Title.Text = "正在进行发票修复准备";
            this.fpxf_progressBar.Location = new Point(0x15, 60);
        ...
        public void SetTip(string title, string tip, string Topic = "发票修复过程")
        {
            this.Text = Topic;
