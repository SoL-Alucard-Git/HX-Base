namespace Aisino.Fwkp.Bmgl.Forms
{
    ...
    public class BMGHDWSelect : BaseForm
    {
        ...
        private ILog log;
        private BMGHDWManager purchaseManager;
        ...
        {
            this.SelectedBM = "";
            this.purchaseManager = new BMGHDWManager();
            this.log = LogUtil.GetLogger<BMGHDWSelect>();
            this.SelectedSJBM = "";
        ...
        public BMGHDWSelect(string keyWord)
        {
            this.SelectedBM = "";
            this.purchaseManager = new BMGHDWManager();
            this.log = LogUtil.GetLogger<BMGHDWSelect>();
        ...
        {
            this.purchaseManager.CurrentPage = e.PageNO;
            this.purchaseManager.Pagesize = e.PageSize;
            this.dataSet = this.purchaseManager.QueryData(e.PageSize, e.PageNO);
            this.aisinoDataGrid1.DataSource = this.dataSet;
            this.ChangeCanSelect();
        }

        private void BMGHDWSelect_Load(object sender, EventArgs e)
        {
            ...
            this.treeViewBM1.RootNodeString = "购货单位编码";
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            try
            {
                this.purchaseManager.CurrentPage = 1;
                this.KeyWord = this.textBoxWaitKey.Text.Trim();
                this.dataSet = this.purchaseManager.QueryByKey(this.KeyWord, this.purchaseManager.Pagesize, this.purchaseManager.CurrentPage);
                this.aisinoDataGrid1.DataSource = this.dataSet;
            }
            catch (Exception exception)
            {
        ...
        private void Initialize()
        {
            ...
            this.textBoxWaitKey.ToolTipText = "输入关键字(编码,名称或税号)";
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(BMGHDWSelect));
            ...
            this.xmlComponentLoader1.Text = "BMGHDWSelect";
            this.xmlComponentLoader1.XMLPath = @"..\Config\Components\Aisino.Fwkp.Bmgl.Forms.BMGHDWSelect\Aisino.Fwkp.Bmgl.Forms.BMGHDWSelect.xml";
            base.AutoScaleDimensions = new SizeF(6f, 12f);
            base.AutoScaleMode = AutoScaleMode.Font;
            base.ClientSize = new Size(0x3e8, 600);
            base.Controls.Add(this.xmlComponentLoader1);
            base.KeyPreview = true;
            base.Name = "BMGHDWSelect";
            base.Tag = manager.GetObject("$this.Tag");
            this.Text = "购货单位选择";
            base.Load += new EventHandler(this.BMGHDWSelect_Load);
        ...
        {
            return this.purchaseManager.listNodes(ParentBM);
        }
        ...
        private bool treeViewBM1_onTreeNodeClick(object sender, TreeViewEventArgs e)
        {
            ...
            this.purchaseManager.CurrentPage = 1;
            this.dataSet = this.purchaseManager.SelectNodeDisplay(this.selectbm, this.purchaseManager.Pagesize, this.purchaseManager.CurrentPage);
            this.aisinoDataGrid1.DataSource = this.dataSet;
            this.ChangeCanSelect();
            return true;
        }
