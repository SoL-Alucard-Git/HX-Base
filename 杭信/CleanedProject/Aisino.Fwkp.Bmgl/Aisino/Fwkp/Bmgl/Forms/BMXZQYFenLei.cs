namespace Aisino.Fwkp.Bmgl.Forms
{
    ...
    public class BMXZQYFenLei : BaseForm
    {
        ...
        {
            this.InModel();
            if (this.khlogical.AddDistrict(this.khModel) == "0")
            {
        ...
        private void BMXZQY_Edit_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    this.textBoxSJBM.SelectBM = this.bm;
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(BMXZQYFenLei));
            ...
            this.xmlComponentLoader1.XMLPath = @"..\Config\Components\Aisino.Fwkp.Bmgl.Forms.BMXZQYFenLei\Aisino.Fwkp.Bmgl.Forms.BMXZQYFenLei.xml";
        ...
        private void UpdateKH()
        {
            ...
            {
                switch (this.khlogical.ModifyDistrict(this.khModel, this.yuanBM))
                {
                    case "0":
                        MessageManager.ShowMsgBox("INP-235403");
                        base.DialogResult = DialogResult.OK;
