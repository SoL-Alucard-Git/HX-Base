namespace Aisino.Fwkp.Bmgl.Forms
{
    ...
    public class BMGHDWFenLei : BaseForm
    {
        ...
        private BLL.BMGHDWManager ghdwlogical;
        ...
        {
            this.InModel();
            if (this.ghdwlogical.AddPurchase(this.ghdwModel) == "0")
            {
        ...
        {
            this.resultModifyBM = this.ghdwlogical.UpdateSubNodesSJBM(this.ghdwModel, this.bm);
        }
        ...
        private void Initialize()
        {
            ...
            this.textBoxWaitMC.WaterMarkString = "购货单位分类名称";
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(BMGHDWFenLei));
            ...
            this.xmlComponentLoader1.Text = "BMGHDWFenLei";
            this.xmlComponentLoader1.XMLPath = @"..\Config\Components\Aisino.Fwkp.Bmgl.Forms.BMGHDWFenLei\Aisino.Fwkp.Bmgl.Forms.BMGHDWFenLei.xml";
            ...
            base.Name = "BMGHDWFenLei";
            base.StartPosition = FormStartPosition.CenterScreen;
            base.Tag = manager.GetObject("$this.Tag");
            this.Text = "BMGHDWFenLei";
        ...
        private void InModel()
        {
            ...
            this.ghdwModel.BM = this.textBoxBM.Text;
            this.ghdwModel.MC = this.textBoxWaitMC.Text;
            this.ghdwModel.SJBM = this.textBoxSJBM.Text;
            this.ghdwModel.WJ = 0;
        ...
        private bool textBoxBM_Validating()
        {
            ...
            {
                DAL.BMGHDWManager manager = new DAL.BMGHDWManager();
        ...
        private void textBoxSJBM_selectChanged(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            else
            {
                ...
                this.SuggestBM = this.ghdwlogical.TuiJianBM(e.Node.Name);
                this.textBoxBM.Select(this.textBoxBM.Text.Length, 0);
            }
        }
        ...
        private void treeviewneed_onTreeNodeDoubleClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            this.bm = this.ghdwlogical.TuiJianBM(this.textBoxSJBM.Text);
            this.textBoxBM.Text = this.bm;
            this.textBoxBM.Select(this.textBoxBM.Text.Length, 0);
        }

        private void UpdateGHDW()
        {
            this.InModel();
            if (this.yuanBM == this.ghdwModel.BM)
            {
                switch (this.ghdwlogical.ModifyPurchase(this.ghdwModel, this.yuanBM))
                {
                    case "0":
                        MessageManager.ShowMsgBox("INP-235403");
                        base.DialogResult = DialogResult.OK;
            ...
            {
                this.resultModifyBM = this.ghdwlogical.UpdateSubNodesSJBM(this.ghdwModel, this.yuanBM);
                if (this.resultModifyBM == "0")
                {
                    MessageManager.ShowMsgBox("INP-235403");
                    base.DialogResult = DialogResult.OK;
