namespace Aisino.Fwkp.Bmgl.Forms
{
    ...
    public class BMCLSelect : BaseForm
    {
        ...
        {
            this.SelectedBM = "";
            this.clManager = new BMCLManager();
            this.log = LogUtil.GetLogger<BMCLSelect>();
            this.SelectedSJBM = "";
        ...
        public BMCLSelect(string keyWord)
        {
            this.SelectedBM = "";
            this.clManager = new BMCLManager();
            this.log = LogUtil.GetLogger<BMCLSelect>();
        ...
        {
            this.clManager.CurrentPage = e.PageNO;
            this.clManager.Pagesize = e.PageSize;
            this.dataSet = this.clManager.QueryData(e.PageSize, e.PageNO);
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            try
            {
                this.clManager.CurrentPage = 1;
                this.KeyWord = this.textBoxWaitKey.Text.Trim();
                this.dataSet = this.clManager.QueryByKey(this.KeyWord, this.clManager.Pagesize, this.clManager.CurrentPage);
                this.aisinoDataGrid1.DataSource = this.dataSet;
            }
            catch (Exception exception)
            {
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(BMCLSelect));
            ...
            this.xmlComponentLoader1.Text = "BMCLSelect";
            this.xmlComponentLoader1.XMLPath = @"..\Config\Components\Aisino.Fwkp.Bmgl.Forms.BMCLSelect\Aisino.Fwkp.Bmgl.Forms.BMCLSelect.xml";
            base.AutoScaleDimensions = new SizeF(6f, 12f);
            base.AutoScaleMode = AutoScaleMode.Font;
            base.ClientSize = new Size(0x3e8, 600);
            base.Controls.Add(this.xmlComponentLoader1);
            base.KeyPreview = true;
            base.Name = "BMCLSelect";
            base.Tag = manager.GetObject("$this.Tag");
            this.Text = "车辆编码选择";
            base.Load += new EventHandler(this.BMCLSelect_Load);
        ...
        private bool treeViewBM1_onTreeNodeClick(object sender, TreeViewEventArgs e)
        {
            ...
            this.clManager.CurrentPage = 1;
            this.dataSet = this.clManager.SelectNodeDisplay(this.selectbm, this.clManager.Pagesize, this.clManager.CurrentPage);
            this.aisinoDataGrid1.DataSource = this.dataSet;
            this.ChangeCanSelect();
            return true;
        }
