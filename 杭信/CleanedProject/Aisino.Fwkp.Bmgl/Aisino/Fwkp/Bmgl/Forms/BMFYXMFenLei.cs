namespace Aisino.Fwkp.Bmgl.Forms
{
    ...
    public class BMFYXMFenLei : BaseForm
    {
        ...
        {
            this.InModel();
            if (this.fyxmlogical.AddExpense(this.fyxmModel) == "0")
            {
        ...
        {
            this.resultModifyBM = this.fyxmlogical.UpdateSubNodesSJBM(this.fyxmModel, this.bm);
        }
        ...
        private void Initialize()
        {
            ...
            this.textBoxWaitMC.WaterMarkString = "费用项目分类名称";
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(BMFYXMFenLei));
            ...
            this.xmlComponentLoader1.Text = "BMFYXMFenLei";
            this.xmlComponentLoader1.XMLPath = @"..\Config\Components\Aisino.Fwkp.Bmgl.Forms.BMFYXMFenLei\Aisino.Fwkp.Bmgl.Forms.BMFYXMFenLei.xml";
            ...
            base.Name = "BMFYXMFenLei";
            base.StartPosition = FormStartPosition.CenterScreen;
            base.Tag = manager.GetObject("$this.Tag");
            this.Text = "BMFYXMFenLei";
        ...
        private void InModel()
        {
            ...
            this.fyxmModel.BM = this.textBoxBM.Text;
            this.fyxmModel.MC = this.textBoxWaitMC.Text;
            this.fyxmModel.SJBM = this.textBoxSJBM.Text;
            this.fyxmModel.WJ = 0;
        ...
        private bool textBoxBM_Validating()
        {
            ...
            {
                DAL.BMFYXMManager manager = new DAL.BMFYXMManager();
        ...
        private void treeviewneed_onTreeNodeDoubleClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            this.bm = this.fyxmlogical.TuiJianBM(this.textBoxSJBM.Text);
            this.textBoxBM.Text = this.bm;
            this.textBoxBM.Select(this.textBoxBM.Text.Length, 0);
        }

        private void UpdateFYXM()
        {
            this.InModel();
            if (this.yuanBM == this.fyxmModel.BM)
            {
                switch (this.fyxmlogical.ModifyExpense(this.fyxmModel, this.yuanBM))
                {
                    case "0":
                        MessageManager.ShowMsgBox("INP-235403");
                        base.DialogResult = DialogResult.OK;
            ...
            {
                this.resultModifyBM = this.fyxmlogical.UpdateSubNodesSJBM(this.fyxmModel, this.yuanBM);
                if (this.resultModifyBM == "0")
                {
                    MessageManager.ShowMsgBox("INP-235403");
                    base.DialogResult = DialogResult.OK;
