namespace Aisino.Fwkp.Bmgl.Forms
{
    ...
    public class BMSFHRFenLei : BaseForm
    {
        ...
        private BLL.BMSFHRManager sfhrManager;
        ...
        {
            this.InModel();
            if (this.sfhrManager.AddCustomer(this.sfhrModel) == "0")
            {
        ...
        {
            this.resultModifyBM = this.sfhrManager.UpdateSubNodesSJBM(this.sfhrModel, this.bm);
        }
        ...
        private void Initialize()
        {
            ...
            this.textBoxWaitMC.WaterMarkString = "收发货人分类名称";
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(BMSFHRFenLei));
            ...
            this.xmlComponentLoader1.Text = "BMSFHRFenLei";
            this.xmlComponentLoader1.XMLPath = @"..\Config\Components\Aisino.Fwkp.Bmgl.Forms.BMSFHRFenLei\Aisino.Fwkp.Bmgl.Forms.BMSFHRFenLei.xml";
            ...
            base.Name = "BMSFHRFenLei";
            base.StartPosition = FormStartPosition.CenterScreen;
            base.Tag = manager.GetObject("$this.Tag");
            this.Text = "BMSFHRFenLei";
        ...
        private void InModel()
        {
            ...
            this.sfhrModel.BM = this.textBoxBM.Text;
            this.sfhrModel.MC = this.textBoxWaitMC.Text;
            this.sfhrModel.KJM = CommonFunc.GenerateKJM(this.textBoxWaitMC.Text.Trim());
            this.sfhrModel.SJBM = this.textBoxSJBM.Text;
            this.sfhrModel.JM = "";
            this.sfhrModel.WJ = 0;
        ...
        private bool textBoxBM_Validating()
        {
            ...
            {
                DAL.BMSFHRManager manager = new DAL.BMSFHRManager();
        ...
        private void treeviewneed_onTreeNodeDoubleClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            this.bm = this.sfhrManager.TuiJianBM(this.textBoxSJBM.Text);
        ...
        {
            this.InModel();
            if (this.yuanBM == this.sfhrModel.BM)
            {
                switch (this.sfhrManager.ModifyCustomer(this.sfhrModel, this.yuanBM))
                {
                    case "0":
                        MessageManager.ShowMsgBox("INP-235403");
                        base.DialogResult = DialogResult.OK;
            ...
            {
                this.resultModifyBM = this.sfhrManager.UpdateSubNodesSJBM(this.sfhrModel, this.yuanBM);
                if (this.resultModifyBM == "0")
                {
                    MessageManager.ShowMsgBox("INP-235403");
                    base.DialogResult = DialogResult.OK;
