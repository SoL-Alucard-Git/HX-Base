namespace Aisino.Fwkp.Bmgl.Forms
{
    ...
    public class BMXHDWFenLei : BaseForm
    {
        ...
        private BLL.BMXHDWManager xhdwManager;
        ...
        public BMXHDWFenLei(BMXHDW Father, string BM, bool Isupdate)
        {
            this.xhdwManager = new BLL.BMXHDWManager();
            this.xhdwModel = new BMXHDWModel();
            this.bm = "";
        ...
        {
            this.InModel();
            if (this.xhdwManager.AddCustomer(this.xhdwModel) == "0")
            {
        ...
        {
            this.resultModifyBM = this.xhdwManager.UpdateSubNodesSJBM(this.xhdwModel, this.bm);
        }
        ...
        private void BMXHDW_Edit_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    this.SuggestBM = this.xhdwManager.TuiJianBM(this._sjbm);
        ...
        private void Initialize()
        {
            ...
            this.textBoxWaitMC.WaterMarkString = "销货单位分类名称";
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(BMXHDWFenLei));
            ...
            this.xmlComponentLoader1.Text = "BMXHDWFenLei";
            this.xmlComponentLoader1.XMLPath = @"..\Config\Components\Aisino.Fwkp.Bmgl.Forms.BMXHDWFenLei\Aisino.Fwkp.Bmgl.Forms.BMXHDWFenLei.xml";
            ...
            base.Name = "BMXHDWFenLei";
            base.StartPosition = FormStartPosition.CenterScreen;
            base.Tag = manager.GetObject("$this.Tag");
            this.Text = "BMXHDWFenLei";
        ...
        private void InModel()
        {
            ...
            this.xhdwModel.BM = this.textBoxBM.Text;
            this.xhdwModel.MC = this.textBoxWaitMC.Text;
            this.xhdwModel.SJBM = this.textBoxSJBM.Text;
            this.xhdwModel.WJ = 0;
        ...
        private bool textBoxBM_Validating()
        {
            ...
            if (!this.isUpdate)
            {
                ...
                if (!("NoXJBM" != this.xhdwManager.ChildDetermine(this.textBoxBM.Text.Trim(), this._sjbm)) || (this.textBoxBM.Text.Length == this.xhdwManager.GetSuggestBMLen(this._sjbm)))
                {
                    return flag;
                }
                this.textBoxBM.Text = this.SuggestBM;
            ...
            {
                DAL.BMXHDWManager manager = new DAL.BMXHDWManager();
            ...
            if (!("OnlyBMAndIsSelf" != this.xhdwManager.ChildDetermine(this.yuanBM, this._sjbm)) || (this.textBoxBM.Text.Length == this.xhdwManager.GetSuggestBMLen(this._sjbm)))
            {
                return flag;
            }
            if (this.textBoxSJBM.Text != this.xhdwModel.SJBM)
        ...
        private void textBoxSJBM_selectChanged(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    this.textBoxBM.Text = this.xhdwManager.TuiJianBM(e.Node.Name);
                }
                this.SuggestBM = this.xhdwManager.TuiJianBM(e.Node.Name);
                this.textBoxBM.Select(this.textBoxBM.Text.Length, 0);
            }
        }
            ...
            try
            {
                if (this.SimpleValidated())
                {
                    ...
                    if (this.xhdwManager.AddCustomer(this.xhdwModel) == "0")
                    {
                        ...
                        MessageManager.ShowMsgBox("INP-235401");
                        this.textBoxBM.Text = this.xhdwManager.TuiJianBM(this.textBoxSJBM.Text);
        ...
        {
            return this.xhdwManager.listNodes(ParentBM);
        }
        ...
        private void treeviewneed_onTreeNodeDoubleClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            this.bm = this.xhdwManager.TuiJianBM(this.textBoxSJBM.Text);
        ...
        {
            this.InModel();
            if (this.yuanBM == this.xhdwModel.BM)
            {
                switch (this.xhdwManager.ModifyCustomer(this.xhdwModel, this.yuanBM))
                {
                    case "0":
                        MessageManager.ShowMsgBox("INP-235403");
                        base.DialogResult = DialogResult.OK;
            ...
            {
                this.resultModifyBM = this.xhdwManager.UpdateSubNodesSJBM(this.xhdwModel, this.yuanBM);
                if (this.resultModifyBM == "0")
                {
                    MessageManager.ShowMsgBox("INP-235403");
                    base.DialogResult = DialogResult.OK;
