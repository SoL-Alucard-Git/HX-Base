namespace Aisino.Fwkp.Bmgl.Forms
{
    ...
    public class BMSFHRSelect : BaseForm
    {
        ...
        public BMSFHRSelect()
        {
            ...
            this.log = LogUtil.GetLogger<BMSFHRSelect>();
            this.SelectedSJBM = "";
        ...
        public BMSFHRSelect(string keyWord)
        {
            this.SelectedBM = "";
            this.sfhrManager = new BMSFHRManager();
            this.log = LogUtil.GetLogger<BMSFHRSelect>();
        ...
        private void BMSFHRSelect_Load(object sender, EventArgs e)
        {
            ...
            this.treeViewBM1.RootNodeString = "收/发货人编码";
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(BMSFHRSelect));
            ...
            this.xmlComponentLoader1.Text = "BMSFHRSelect";
            this.xmlComponentLoader1.XMLPath = @"..\Config\Components\Aisino.Fwkp.Bmgl.Forms.BMSFHRSelect\Aisino.Fwkp.Bmgl.Forms.BMSFHRSelect.xml";
            base.AutoScaleDimensions = new SizeF(6f, 12f);
            base.AutoScaleMode = AutoScaleMode.Font;
            base.ClientSize = new Size(0x3e8, 600);
            base.Controls.Add(this.xmlComponentLoader1);
            base.KeyPreview = true;
            base.Name = "BMSFHRSelect";
            base.Tag = manager.GetObject("$this.Tag");
            this.Text = "收/发货人选择";
            base.Load += new EventHandler(this.BMSFHRSelect_Load);
