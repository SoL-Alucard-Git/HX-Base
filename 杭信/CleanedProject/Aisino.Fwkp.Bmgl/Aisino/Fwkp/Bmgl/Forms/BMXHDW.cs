namespace Aisino.Fwkp.Bmgl.Forms
{
    ...
    public class BMXHDW : BMBase<BMXHDW_Edit, BMXHDWFenLei, BMXHDWSelect>
    {
        ...
        public BMXHDW()
        {
            ...
            base.log = LogUtil.GetLogger<BMXHDW>();
            base.bllManager = this.xhdwManager;
        }
        ...
        private void InitializeComponent()
        {
            base.Name = "BMXHDW";
            this.Text = "销货单位编码设置";
            base.treeViewBM1.RootNodeString = "销货单位编码";
            base.treeViewBM1.ChildText = "增加销货单位编码";
