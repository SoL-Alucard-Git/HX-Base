namespace Aisino.Fwkp.Bmgl.BLLSys
{
    ...
    internal sealed class GetGHDW : AbstractService
    {
        ...
        protected override object[] doService(object[] param)
        {
            ...
            switch (num)
            {
                ...
                case 1:
                {
                    DataTable table2 = this.ghdwmanager.AppendByKey(keyWord, 1);
                ...
                case 2:
                {
                    DataTable table4 = this.ghdwmanager.AppendByKeyWJ(keyWord, 1);
