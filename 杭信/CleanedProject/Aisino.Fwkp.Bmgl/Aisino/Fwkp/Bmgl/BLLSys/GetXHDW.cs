namespace Aisino.Fwkp.Bmgl.BLLSys
{
    ...
    internal sealed class GetXHDW : AbstractService
    {
        ...
        protected override object[] doService(object[] param)
        {
            ...
            switch (num)
            {
                ...
                case 1:
                {
                    DataTable table2 = this.xhdwManager.AppendByKey(keyWord, 1);
                ...
                case 2:
                {
                    DataTable table4 = this.xhdwManager.AppendByKeyWJ(keyWord, 1);
