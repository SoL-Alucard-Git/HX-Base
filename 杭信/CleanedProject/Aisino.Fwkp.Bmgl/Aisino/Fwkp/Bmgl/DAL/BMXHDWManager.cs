namespace Aisino.Fwkp.Bmgl.DAL
{
    ...
    internal class BMXHDWManager : IBMXHDWManager
    {
        ...
        public DataTable AppendByKey(string KeyWord, int TopNo)
        {
            ...
            DataTable table = this.baseDAO.querySQLDataTable("aisino.Fwkp.Bmgl.BMXHDW.XHDWqueryKeyAppendWJ", dictionary);
        ...
        public int BmMaxLenth(string BM)
        {
            ...
            return this.baseDAO.queryValueSQL<int>("aisino.Fwkp.Bmgl.BMXHDW.XHDWBmZWverify", dictionary);
        }
        ...
        public string ChildDetermine(string BM, string SJBM)
        {
            ...
            DataTable table = this.baseDAO.querySQLDataTable("aisino.Fwkp.Bmgl.BMXHDW.XHDWChildDetermine", dictionary);
        ...
        public string DeleteCustomer(string customerCode)
        {
            ...
            if (this.baseDAO.queryValueSQL<int>("aisino.Fwkp.Bmgl.BMXHDW.XHDWExist", dictionary) == 0)
            {
                return "eDoseNotExist";
            }
            int num2 = this.baseDAO.未确认DAO方法2_疑似updateSQL("aisino.Fwkp.Bmgl.BMXHDW.XHDWDelete", dictionary);
            if (num2 > 0)
            {
        ...
        public string deleteFenLei(string flBM)
        {
            ...
            return this.baseDAO.未确认DAO方法2_疑似updateSQL("aisino.Fwkp.Bmgl.BMXHDW.XHDWDeleteFenLei", dictionary).ToString();
        }
        ...
        public string deleteNodes(string searchid)
        {
            ...
            int num = this.baseDAO.未确认DAO方法2_疑似updateSQL("aisino.Fwkp.Bmgl.BMXHDW.XHDWDeleteSubNodes", dictionary);
            if (num > 0)
            {
                return num.ToString();
            }
        ...
        public string ExecZengJianWei(string BM, bool isZengWei)
        {
            ...
            if (table.Rows.Count > 0)
            {
                ...
                num = this.baseDAO.未确认DAO方法3("aisino.Fwkp.Bmgl.BMXHDW.XHDWBMUpdateSJBMandBM", list);
            }
            if (num > 0)
            {
                return "0";
        ...
        public bool ExistCusMC(string oldBM, string MC, string SJBM)
        {
            ...
            dictionary.Add("SJBM", SJBM);
            DataTable table = this.baseDAO.querySQLDataTable("aisino.Fwkp.Bmgl.BMXHDW.XHDWMCExist", dictionary);
        ...
        public bool ExistCusTaxCode(string CusTaxCode, string OldBM = "NoOldBM")
        {
            ...
            return (this.baseDAO.queryValueSQL<int>("aisino.Fwkp.Bmgl.BMXHDW.XHDWSHExist", dictionary) > 0);
        }
        ...
        public bool FenLeiHasChild(string fenLeiBM)
        {
            ...
            return (this.baseDAO.queryValueSQL<int>("aisino.Fwkp.Bmgl.BMXHDW.XHDWHasChild", dictionary) > 0);
        }

        public DataTable GetExportData()
        {
            return this.baseDAO.querySQLDataTable("aisino.Fwkp.Bmgl.BMXHDW.XHDWqueryKeyout", this.condition);
        }
        ...
        public DataTable GetKH(string BM)
        {
            Dictionary<string, object> dictionary = new Dictionary<string, object>();
            dictionary.Add("bm", BM);
            return this.baseDAO.querySQLDataTable("aisino.Fwkp.Bmgl.BMXHDW.XHDWGetModel", dictionary);
        }
        ...
        public int GetSuggestBMLen(string SJBM)
        {
            Dictionary<string, object> dictionary = new Dictionary<string, object>();
            dictionary.Add("SJBM", SJBM);
            DataTable table = this.baseDAO.querySQLDataTable("aisino.Fwkp.Bmgl.BMXHDW.GetXJBMBySJBM", dictionary);
        ...
        public bool JianWeiVerify(string BM)
        {
            Dictionary<string, object> dictionary = new Dictionary<string, object>();
            dictionary.Add("bm", BM);
            return (this.baseDAO.queryValueSQL<string>("aisino.Fwkp.Bmgl.BMXHDW.XHDWBmJWVerify", dictionary) == "0");
        }
        ...
        public List<TreeNodeTemp> listNodes(string searchid)
        {
            ...
            try
            {
                ...
                DataTable table = this.baseDAO.querySQLDataTable("aisino.Fwkp.Bmgl.BMXHDW.XHDWTreeView", dictionary);
                for (int i = 0; i < table.Rows.Count; i++)
                {
        ...
        public AisinoDataSet QueryByKey(string KeyWord, int pagesize, int pageno)
        {
            ...
            this.SQLID = "aisino.Fwkp.Bmgl.BMXHDW.XHDWqueryKey";
        ...
        public DataTable QueryByMCAndSJBM(string MC, string SJBM)
        {
            ...
            dictionary.Add("MC", MC);
            dictionary.Add("SJBM", SJBM);
            return this.baseDAO.querySQLDataTable("aisino.Fwkp.Bmgl.BMXHDW.XHDWqueryMCAndSJBM", dictionary);
        }
        ...
        public DataTable QueryByTaxCode(string TaxCode)
        {
            ...
            return this.baseDAO.querySQLDataTable("aisino.Fwkp.Bmgl.BMXHDW.XHDWquerySH", dictionary);
        }
        ...
        public AisinoDataSet SelectNodeDisplay(string selectBM, int Pagesize, int Pageno)
        {
            ...
            this.SQLID = "aisino.Fwkp.Bmgl.BMXHDW.XHDWbmlike";
            return this.baseDAO.querySQLDataSet(this.SQLID, this.condition, Pagesize, Pageno);
        }
        ...
        public string TuiJianBM(string searchid)
        {
            ...
            ArrayList list = this.baseDAO.querySQL("aisino.Fwkp.Bmgl.BMXHDW.XHDWRecommend", dictionary);
        ...
        public bool ZengWeiVerify(string BM)
        {
            Dictionary<string, object> dictionary = new Dictionary<string, object>();
            dictionary.Add("bm", BM + "%");
            if (this.baseDAO.queryValueSQL<int>("aisino.Fwkp.Bmgl.BMXHDW.XHDWBmZWverify", dictionary) >= 0x10)
            {
                return false;
            }
            return true;
