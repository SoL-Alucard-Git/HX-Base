namespace Aisino.Fwkp.Bmgl.DAL
{
    ...
    internal class BMCDManager : IBMCDManager
    {
        ...
        public AisinoDataSet QueryByKey(string KeyWord, int pagesize, int pageno)
        {
            ...
            this.SQLID = "aisino.Fwkp.Bmgl.BMCD.CDQueryByKey";
        ...
        public AisinoDataSet QueryCD(int pagesize, int pageno)
        {
            ...
            this.SQLID = "aisino.Fwkp.Bmgl.BMCD.CDbmlike";
            return this.baseDAO.querySQLDataSet(this.SQLID, this.condition, pagesize, pageno);
        }
        ...
        {
            this.condition.Clear();
            this.SQLID = "aisino.Fwkp.Bmgl.BMCD.CDQueryTable";
            return this.baseDAO.querySQLDataSet(this.SQLID, this.condition, pagesize, pageno);
        }
