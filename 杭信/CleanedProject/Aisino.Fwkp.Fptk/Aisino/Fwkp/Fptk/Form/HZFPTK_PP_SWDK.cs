namespace Aisino.Fwkp.Fptk.Form
{
    ...
    public class HZFPTK_PP_SWDK : BaseForm
    {
        ...
        {
            int num;
            if (!base.TaxCardInstance.QYLX.ISTLQY || ((int)this.fplx != 11))
            {
                goto Label_0161;
            }
            string str = this.txt_fpdm.Text.Trim();
            string s = this.txt_fphm.Text.Trim();
        ...
        Label_0091:
            ...
            if (((str.Length == 0) && (s.Length != 0)) || ((str.Length > 0) && (str.Length != 10)))
            {
                MessageManager.ShowMsgBox("INP-242107");
                this.start = 0;
                return;
            }
            if ((((this.mCurDmHm != null) && (this.mCurDmHm.Length == 2)) && (int.TryParse(s, out num) && (this.mCurDmHm[0] == str))) && (int.Parse(this.mCurDmHm[1]) == num))
            {
        ...
        private string CanEmptyRedFp()
        {
            ...
            if (HttpsSender.SendMsg("0007", str4, out xml) == 0)
            {
                ...
                decimal.TryParse(document1.SelectSingleNode("/FPXT/OUTPUT").SelectSingleNode("HZJE").InnerText, out num2);
        ...
        private bool CheckFpdm()
        {
            ...
            if (str.Length != 0)
            {
                ...
                if (!(str.Trim(trimChars) == ""))
                {
                    ...
                    if (((int)this.fplx == 12) && (str.Length == 10))
                    {
                        return false;
                    }
                    return true;
        ...
        private void txt_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if ((((int)this.fplx == 2) || ((int)this.fplx == 12)) || ((int)this.fplx == 0x33))
            {
                if (!(input == ""))
                {
                    char[] trimChars = new char[] { '0' };
        ...
        Label_008B:
            ...
            if (((((int)this.fplx == 2) || ((int)this.fplx == 12)) || ((int)this.fplx == 0x33)) && ((((this.mCurDmHm != null) && (this.mCurDmHm.Length == 2)) && (int.TryParse(input, out num2) && (this.mCurDmHm[0] == str2))) && (int.Parse(this.mCurDmHm[1]) == num2)))
            {
                this.but_xyb.Enabled = false;
            }
