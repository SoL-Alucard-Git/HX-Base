namespace Aisino.Fwkp.Fptk.Form
{
    ...
    public class InvoiceForm_JS : InvoiceForm
    {
        ...
        public static string dy_mb = "NEW76mmX177mm";
        ...
        private string regeditFilePath;
        ...
        private ToolStripButton tool_shezhi;
        ...
        internal InvoiceForm_JS(FPLX fplx, string fpdm, string fphm)
        {
            this.tip = new ToolTip();
            this.blueJe = string.Empty;
            this.regeditFilePath = "";
            this.log = LogUtil.GetLogger<InvoiceForm_JS>();
            this.djfile = "";
        ...
        internal InvoiceForm_JS(FPLX fplx, ZYFP_LX zyfplx, string fpdm, string fphm)
        {
            this.tip = new ToolTip();
            this.blueJe = string.Empty;
            this.regeditFilePath = "";
            ...
            {
                if (((int)zyfplx == 0) && !base.TaxCardInstance.QYLX.ISPTFPJSP)
                {
                    string[] textArray3 = new string[] { " 无增值税普通发票(卷票)授权。" };
                    MessageManager.ShowMsgBox("INP-242114", textArray3);
                    return;
                }
                if (((int)zyfplx == 8) && !base.TaxCardInstance.QYLX.ISNCPXS)
                {
                    string[] textArray4 = new string[] { " 无农产品销售发票授权。" };
                    MessageManager.ShowMsgBox("INP-242158", textArray4);
                    return;
                }
                if (((int)zyfplx == 9) && !base.TaxCardInstance.QYLX.ISNCPSG)
                {
                    string[] textArray5 = new string[] { " 无收购发票授权。" };
                    MessageManager.ShowMsgBox("INP-242159", textArray5);
                    return;
                }
            }
            ...
            else if (((int)fplx == 0x29) && ((int)zyfplx == 9))
            {
                this.isNcpsgfp = true;
                this.zyfplx = zyfplx;
            }
        ...
        public InvoiceForm_JS(FPLX fplx, string fpdm, string fphm, int flag, byte[] value)
        {
            this.tip = new ToolTip();
            this.blueJe = string.Empty;
            this.regeditFilePath = "";
            ...
            if (flag == 1)
            {
                string str = "Aisino.Fwkp.Invoice.ActiveX.Invoice_JS" + fpdm + fphm;
        ...
        protected override void _comboBox_SLV_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if ((((selectedItem.fplx == 0) && ((int)selectedItem.Zyfplx == 1)) || (((int)base._fpxx.Zyfplx == 1) && (selectedItem.Zyfplx == 0))) && !base._fpxx.SetZyfpLx(selectedItem.Zyfplx))
                {
                ...
                else
                {
                    ...
                    else
                    {
                        if (base._fpxx.Fplx == 0)
                        {
                            ...
                            if (((selectedItem != null)) && (selectedItem.fplx == 0) && (selectedItem.Zyfplx == (ZYFP_LX)1))
                            {
        ...
        protected override void _dataGridView_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            switch (columnIndex)
            {
                case 0:
                    ...
                    flag = base._fpxx.SetSpmc(rowIndex, str);
                    if (this.isSnyZyfp)
                    {
                ...
                case 1:
                    flag = base._fpxx.SetGgxh(rowIndex, str);
                    break;

                case 2:
                    flag = base._fpxx.SetJLdw(rowIndex, str);
                    break;

                case 3:
                    flag = base._fpxx.SetSL(rowIndex, str);
                    break;

                case 4:
                    flag = base._fpxx.SetDj(rowIndex, str);
                    break;

                case 5:
                    flag = base._fpxx.SetJe(rowIndex, str);
                    break;
                ...
                case 6:
                    ...
                    flag = base._fpxx.SetSLv(rowIndex, str);
                    break;

                case 7:
                    flag = base._fpxx.SetSe(rowIndex, str);
                    break;
            }
            if (!flag)
            {
        ...
        protected override Dictionary<FPLX, List<SLV>> _GetSLvList()
        {
            ...
            if (base._fpxx != null)
            {
                ...
                List<SLV> list = dictionary[(FPLX)0];
                List<SLV> list2 = dictionary[(FPLX)0x29];
                list.Clear();
                list2.Clear();
                ...
                List<string> list3 = new List<string>(sqSLv.Split(separator, StringSplitOptions.None));
                list3.Sort(new Comparison<string>(InvoiceForm_JS.CompareSlvDesc));
                if (base._fpxx.Fplx == 0)
                {
                    foreach (string str2 in list3)
                    {
                        ...
                        if (double.TryParse(str2, out num))
                        {
                            ...
                            else
                            {
                                ...
                                list.Add(new SLV(0, 0, str2, str3, str3));
                            }
                        }
                    }
                    return dictionary;
                }
                if ((int)base._fpxx.Fplx != 0x29)
                {
                    return dictionary;
                }
                if (this.isNcpsgfp)
                {
                    list2.Add(new SLV((FPLX)0x29, (ZYFP_LX)9, "0.00", "0%", "0%"));
                    return dictionary;
                }
                foreach (string str4 in list3)
                {
                    double num3;
                    if (double.TryParse(str4, out num3))
                    {
                        if (num3 == 0.0)
                        {
                            list2.Add(new SLV((FPLX)0x29, (ZYFP_LX)0, "0.00", "0%", "0%"));
                        }
                        else
                        {
                            string str5 = ((num3 * 100.0)).ToString() + "%";
                            list2.Add(new SLV((FPLX)0x29, (ZYFP_LX)0, str4, str5, str5));
                        }
                    }
                }
            }
        ...
        {
            this.qd = new QingDanTianKai(base._onlyShow, base._fpxx.Fpdm, base._fpxx.Fphm, true);
        ...
        {
            base._ShowDataGrid(dataGridView1);
        }
        ...
        protected override void _SetHzxx()
        {
            ...
            this.lab_hj_je.Text = "￥" + decimal.Subtract(decimal.Parse(base._fpxx.GetHjJeHs()), decimal.Parse(base._fpxx.GetHjSe())).ToString();
        ...
        public override void _spmcBt_leave(object sender, EventArgs e)
        {
            if (!this.isWM() && (base._spmcBt.Parent != null))
            {
                ...
                if (base._spmcBt.Text != "")
                {
                    ...
                    DataTable table = this._SpmcOnAutoCompleteDataSource(grid2, str);
                    if ((table == null) || (table.Rows.Count == 0))
                    {
                        if (((spxx != null) && ((spxx[(SPXX)20] == null) || (spxx[(SPXX)20] == ""))) && ((spxx[0] != null) && (spxx[0] != "")))
                        {
        ...
        {
            return decimal.Add(decimal.Parse(a), decimal.Parse(b)).ToString();
        }
        ...
        public void AutoImportDzfp(AutoImport impForm, Djfp djfp)
        {
            if ((djfp != null) && (djfp.Fpxx != null))
            {
                if ((base._fpxx.Fpdm != "0000000000") && (base._fpxx.Fphm != "00000000"))
                {
                    ...
                    if (fpData == null)
                    {
                        ...
                        AutoImport.returncode = "0001";
                        AutoImport.returnmsg = errorMessage;
                    }
                    else
                    {
                        ...
                        if (base._fpxx.MakeCardInvoice(fpData, false))
                        {
                            ...
                            if (this.fpm.SaveXxfp(fpData))
                            {
                                ...
                                AutoImport.returncode = "0000";
                                AutoImport.returnmsg = "发票开具成功！";
                                AutoImport.jqbh = fpData.jqbh;
                                AutoImport.fp_dm = fpData.fpdm;
                                AutoImport.fp_hm = fpData.fphm;
                                AutoImport.kprq = fpData.kprq;
                                ...
                                fpData.Get_Print_Dj(null, 2, buffer4);
                                AutoImport.fp_mw = fpData.mw;
                                AutoImport.jym = fpData.jym;
                                AutoImport.ewm = "";
                                AutoImport.bz = ToolUtil.GetString(Convert.FromBase64String(fpData.bz));
                            }
                            else
                            {
                                ...
                                AutoImport.returncode = "0001";
                                AutoImport.returnmsg = "发票开具成功，数据写库失败！";
                            }
                            this.GetNextFp();
        ...
        internal static string Divide(string a, string b, int decimals)
        {
            return decimal.Round(decimal.Divide(decimal.Parse(a), decimal.Parse(b)), decimals, MidpointRounding.AwayFromZero).ToString("f" + decimals);
        }

        internal bool FillDjxx(Djfp djfp, bool isRed = false)
        {
            bool flag = true;
            ...
            if (isRed)
            {
                base._fpxx.IsRed=true;
            }
            base._fpxx.Xfdzdh=fpxx.xfdzdh;
            base._fpxx.Xfyhzh=fpxx.xfyhzh;
            if (this.fpm.CopyDjfp(fpxx, base._fpxx, isRed))
            {
                if (isRed)
                {
                    base._fpxx.Bz=NotesUtil.GetRedInvNotes(fpxx.blueFpdm, fpxx.blueFphm) + " " + fpxx.bz;
                    base._fpxx.BlueFpdm=fpxx.blueFpdm;
                    base._fpxx.BlueFphm=fpxx.blueFphm;
                }
                return true;
            }
            flag = false;
                                                    ...
                                                    if (index > -1)
                                                    {
                                                        ...
                                                        if (index > -1)
                                                        {
                                                            ...
                                                            if (index > -1)
                                                            {
                                                                ...
                                                                str13 = currRow.Replace(str12, "").Replace("~~", "").Replace("\0", "");
                                                                if (str13.Length == 0)
                                                                {
                                                                    str13 = "0";
                                                                }
        ...
        private void GetNextFp()
        {
            if (this.fpm.CanInvoice(base._fpxx.Fplx))
            {
                ...
                if (current != null)
                {
                    ...
                    string str6 = base._fpxx.Jqbh;
                    PropertyUtil.GetValue("INV-HSJBZ", "1");
                    byte[] destinationArray = new byte[0x20];
                    ...
                    base._fpxx = new Invoice(false, false, true, base._fpxx.Fplx, buffer3, null);
                    base._fpxx.Fpdm=current[0];
                    base._fpxx.Fphm=current[1];
                    base._fpxx.Jqbh=str6;
                    if (this.isNcpsgfp)
                    {
        ...
        {
            base.XmlComponentFile=@"..\Config\Components\Aisino.Fwkp.Fpkj.Form.JSFPtiankai_new\Aisino.Fwkp.Fpkj.Form.JSFPtiankai_new.xml";
            ...
            if (this.mFplx == 0)
            {
                this.panel1.BackgroundImage = Resources.JS;
            }
            else
            {
                this.panel1.BackgroundImage = Resources.JS;
            ...
            this.panel2.AutoScrollMinSize = new Size(0x224, 650);
            ...
            this.tool_shezhi = base._xmlComponentLoader.GetControlByName<ToolStripButton>("tool_shezhi");
            ...
            this.lab_jym = base._xmlComponentLoader.GetControlByName<AisinoLBL>("lab_jym");
            this.lab_fphm = base._xmlComponentLoader.GetControlByName<AisinoLBL>("lab_fphm");
            this.lab_jqbh = base._xmlComponentLoader.GetControlByName<AisinoLBL>("lab_jqbh");
            ...
            base._DataGridView.Columns["SLV"].Visible = false;
            ...
            base._HsjbzButton.Visible = false;
            ...
            this.tool_shezhi.Click += new EventHandler(this.tool_shezhi_Click);
            if (!base._onlyShow)
            {
            ...
            this.tool_kehu.ToolTipText = "保存购方信息";
            this.tool_fanlan.ToolTipText = "红字发票反开蓝字发票";
            this.tool_print.ToolTipText = base._onlyShow ? "发票打印" : "开具发票";
            ...
            this.tool_shezhi.Visible = this.isExitFile();
        }
        ...
        private void InitNextFP(string[] dmhm)
        {
            ...
            {
                base._DataGridView.CurrentCell = base._DataGridView[base._DataGridView.ColumnCount - 5, 0];
        ...
        private void InvoiceForm_Init(FPLX fplx, string fpdm, string fphm)
        {
            ...
            byte[] buffer3 = AES_Crypt.Encrypt(Encoding.Unicode.GetBytes("KP" + DateTime.Now.ToString("F")), destinationArray, buffer2);
            Invoice.IsGfSqdFp_Static=false;
            base._fpxx = new Invoice(false, false, true, fplx, buffer3, dy_mb);
            base._fpxx.Bmbbbh=base.getbmbbbh();
            if (((int)fplx == 0x29) && ((this.zyfplx == (ZYFP_LX)9) || (this.zyfplx == (ZYFP_LX)8)))
            {
                base._fpxx.SetZyfpLx(this.zyfplx);
            }
            if (string.IsNullOrEmpty(base._fpxx.GetSqSLv()))
            {
                ...
                string[] textArray1 = new string[] { str7 };
            ...
            else
            {
                this.Initialize();
                int num = 0;
                string str = this._SetDefaultSpsLv();
                if (this.isSnyZyfp)
                {
                    Spxx spxx = new Spxx("", this._SetDefaultSpsm(), str, "", "吨", "", true, this.zyfplx);
                ...
                else
                {
                    ...
                    num = base._fpxx.AddSpxx(this._SetDefaultSpsm(), str, this.zyfplx);
                }
                if (num < 0)
                {
                    this.initSuccess = false;
                ...
                else
                {
                    ...
                    base._fpxx.Skr=this.com_skr.Text;
                    base._fpxx.Fhr=this.com_fhr.Text;
                    base._fpxx.Jqbh=this.fpm.GetMachineNum();
                    if (this.isNcpsgfp)
                    {
                        base._fpxx.Gfsh=xfsh;
                        base._fpxx.Gfmc=xfmc;
        ...
        {
            RegistryKey key = Registry.LocalMachine.OpenSubKey(@"SOFTWARE\Microsoft\Windows\CurrentVersion\App Paths\BBDY", false);
            if (key != null)
            {
                object obj2 = key.GetValue("PATH");
                if (obj2 == null)
                {
                    return false;
                }
                ...
                {
                    this.regeditFilePath = obj2.ToString();
                    return true;
                }
            }
            return false;
                                    ...
                                    else
                                    {
                                        ...
                                        if (fp.isRed)
                                        {
                                            ...
                                            if (!string.IsNullOrEmpty(str5))
                                            {
                                                ...
                                                else if (base._fpxx.Fplx == (FPLX)0x29)
                                                {
                                                    if (str5.Length == 20)
                                                    {
                                            ...
                                            if ((fp.isRed && (base._fpxx.Fplx == (FPLX)0x29)) && ((fp.blueFpdm.Length == 0) || (fp.blueFphm.Length == 0)))
                                            {
                                        ...
                                        {
                                            flag = this.fpm.CopyDjfp(fp, base._fpxx, false);
                                        }
                                        if (flag)
                                        {
                                            this.isdrdjdk = true;
                                            ...
                                            if (base._DataGridView.RowCount > 0)
                                            {
                                                base._DataGridView.CurrentCell = base._DataGridView[base._DataGridView.ColumnCount - 5, base._DataGridView.RowCount - 1];
                                            }
        ...
        public void RefreshData(bool isRed)
        {
            ...
            byte[] buffer3 = AES_Crypt.Encrypt(Encoding.Unicode.GetBytes("KP" + DateTime.Now.ToString("F")), destinationArray, buffer2);
            Invoice.IsGfSqdFp_Static=false;
            base._fpxx = new Invoice(isRed, false, true, base._fpxx.Fplx, buffer3, dy_mb);
            base._fpxx.Bmbbbh=base.getbmbbbh();
            base._fpxx.SetZyfpLx(this.zyfplx);
            base._fpxx.AddSpxx(this._SetDefaultSpsm(), this._SetDefaultSpsLv(), this.zyfplx);
            base._DataGridView.Rows.Clear();
        ...
        private void SetDrfpQdbz(Fpxx fpxx)
        {
            ...
            {
                if ((base._fpxx.Fplx == (FPLX)0x29) && (fpxx.Mxxx.Count > 7))
                {
                    base._fpxx.SetQdbz(true);
                }
            }
        ...
        private void SetFpSnyLx()
        {
            if (this.com_yplx.SelectedItem != null)
            {
                ZYFP_LX zyfp_lx = (ZYFP_LX)2;
                switch (this.com_yplx.SelectedItem.ToString())
                {
                    case "(石脑油)":
                        zyfp_lx = (ZYFP_LX)2;
                        break;
        ...
        private void SetGridStyle()
        {
            ...
            {
                base._DataGridView.GridColor = System.Drawing.Color.DodgerBlue;
            }
            else
            {
                base._DataGridView.GridColor = System.Drawing.Color.Black;
            }
        }
        ...
        private void SetHysyHsjxx(CustomStyleDataGrid dataGridView1, bool start)
        {
            if (start)
            {
                dataGridView1.Columns["DJ"].HeaderText = "含税单价";
                ...
                {
                    base._DataGridView.Columns["DJ"].HeaderText = "含税单价";
            ...
            else
            {
                ...
                {
                    dataGridView1.Columns["DJ"].HeaderText = "含税单价";
                    dataGridView1.Columns["JE"].HeaderText = "含税金额";
                }
                else
                {
                ...
                if (base._fpxx.Qdbz && (this.qd != null))
                {
                    ...
                    {
                        base._DataGridView.Columns["DJ"].HeaderText = "含税单价";
                        base._DataGridView.Columns["JE"].HeaderText = "含税金额";
                    }
                    else
                    {
        ...
        private void SetSpxx(CustomStyleDataGrid parent, object[] spxx)
        {
            ...
            if ((spxx != null) && (spxx.Length > 15))
            {
                ...
                {
                    string[] textArray1 = new string[] { "当前票种不能选择该税率商品！" };
                    MessageManager.ShowMsgBox("INP-242185", textArray1);
                    return;
                }
                if (!this.isWM())
                {
                    if (((spxx[12].ToString() == "是") && (spxx[15].ToString().Trim() == "")) && !base.Update_SP(spxx))
                    {
                        MessageBox.Show("更新商品库失败!");
                        return;
                    }
                    object[] objArray1 = new object[] { spxx[11].ToString(), true };
                    ...
                    {
                        base._spmcBt.Text = "";
                        string[] textArray2 = new string[] { "商品", "\r\n可能原因：\r\n1、当前企业没有所选税收分类编码授权。\r\n2、当前版本所选税收分类编码可用状态为不可用。" };
                        MessageManager.ShowMsgBox("INP-242207", textArray2);
                        return;
                    }
                }
                string str = spxx[10].ToString();
                decimal.TryParse(spxx[3].ToString(), out num2);
                string str2 = spxx[11].ToString().Trim();
                if (!this.isWM() && (str2.Length < 0x13))
                {
                    str2 = str2.PadRight(0x13, '0');
                }
                string str3 = spxx[12].ToString().Trim();
                string str4 = spxx[15].ToString().Trim();
                spxx[14].ToString().Trim();
                base._fpxx.SetSpbh(rowIndex, spxx[0].ToString());
                base._fpxx.SetFlbm(rowIndex, str2);
                base._fpxx.SetYhsm(rowIndex, str4);
                base.comboBox_SLV.Items.Clear();
                base.comboBox_SLV.Items.AddRange(base.GetSlvList(base._fpxx.Fplx));
                str3 = (str3 == "是") ? "1" : "0";
                base._fpxx.SetXsyh(rowIndex, str3);
                this.SLVLIST_CHANGE(rowIndex);
                bool flag = false;
                int num3 = 0;
                if (base.comboBox_SLV.Items != null)
                {
                    ...
                    {
                        decimal num4;
                        decimal.TryParse(base.GetSL(obj2.ToString()), out num4);
                        if (decimal.Compare(num4, num2) == 0)
                        {
                            flag = true;
                            break;
                        }
                ...
                if (((base._fpxx.Fplx == (FPLX)0x29) && (num2.ToString() == "0.05")) && (str == "True"))
                {
                    MessageManager.ShowMsgBox("INP-242172");
                    return;
                }
                string str5 = spxx[1].ToString();
                if ((str5.Trim() == "") || (str5.Trim() == "0"))
                {
                    str5 = "";
                }
                base._fpxx.SetSpmc(rowIndex, str5);
                if (!base._fpxx.SetSLv(rowIndex, spxx[3].ToString()))
                {
                    MessageManager.ShowMsgBox(base._fpxx.GetCode(), base._fpxx.Params);
                    return;
                }
                if (num2 == decimal.Zero)
                {
                    if (str3 == "1")
                    {
                        ...
                        else if (str4.Contains("出口零税"))
                        {
                            base._fpxx.SetLslvbs(rowIndex, "0");
                        }
                        else if (str4.Contains("不征税"))
                        {
                ...
                base._fpxx.SetSpsm(rowIndex, spxx[4].ToString());
                base._fpxx.SetGgxh(rowIndex, spxx[5].ToString());
                string str6 = spxx[6].ToString();
                if (this.isSnyZyfp)
                {
                    str6 = "吨";
                }
                base._fpxx.SetJLdw(rowIndex, str6);
                base._fpxx.Hsjbz=true;
                base._fpxx.SetDj(rowIndex, spxx[7].ToString());
                base._fpxx.Hsjbz=true;
                if (!base._fpxx.SetDjHsjbz(rowIndex, spxx[8].ToString().Equals("True")))
                {
                    MessageManager.ShowMsgBox(base._fpxx.GetCode(), base._fpxx.Params);
                    return;
                }
        ...
        private void SetTkFormTitle(string fpdm, FPLX fplx)
        {
            ...
            else
            {
                if (this.lab_title.Text.Length == 3)
                {
                    this.lab_title.Location = new Point(this.lblDq.Location.X - 0x72, this.lab_title.Location.Y);
                }
                else
                {
                    this.lab_title.Location = new Point(this.lblDq.Location.X - 110, this.lab_title.Location.Y);
                }
                this.lab_title.ForeColor = System.Drawing.Color.FromArgb(0x94, 0x48, 12);
            }
            if (str.Length == 2)
            {
        ...
        private void ShowInvMainInfo()
        {
            ...
            this.lab_jqbh.Text = base._fpxx.Jqbh;
        ...
        private void SLVLIST_CHANGE(int rowidx)
        {
            ...
            char[] separator = new char[] { ',' };
            string[] source = base._fpxx.GetSqSLv().Split(separator, StringSplitOptions.None);
            bool flag = false;
            if ((source.Contains<string>("0.00") || source.Contains<string>("0")) || source.Contains<string>("0.0"))
            {
                flag = true;
            }
            string[] sYSlv = base.GetSYSlv(dictionary[(SPXX)20], false);
            List<string> list1 = new List<string>();
            list1.AddRange(base.yhzc2slv(str));
            list1.AddRange(source.ToList<string>());
            list1.AddRange(sYSlv.ToList<string>());
            ...
            list = list.GroupBy<double, double>((serializeClass.staticFunc_1)).Select<IGrouping<double, double>, double>((serializeClass.staticFunc_2)).ToList<double>(); list = list.GroupBy<double, double>((serializeClass.staticFunc_1 ?? (serializeClass.staticFunc_1 = new Func<double, double>(serializeClass.instance.slvlistFunc_1)))).Select<IGrouping<double, double>, double>((serializeClass.staticFunc_2 ?? (serializeClass.staticFunc_2 = new Func<IGrouping<double, double>, double>(serializeClass.instance.slvlistFunc_2)))).ToList<double>();
            base.comboBox_SLV.Items.Clear();
            Dictionary<FPLX, List<SLV>> dictionary2 = base._GetSLvList();
            if (base._fpxx != null)
            {
                List<SLV> list2 = dictionary2[(FPLX)0x29];
                list2.Clear();
                list.Sort();
                list.Reverse();
                foreach (double num2 in list)
                {
                    if (num2 == 0.0)
                    {
                        if (!FLBM_lock.isFlbm())
                        {
                            list2.Add(new SLV((FPLX)0x29, (ZYFP_LX)0, "0.00", "免税", "免税"));
                        }
                        else
                        {
                            ...
                            if (str.Contains("不征税"))
                            {
                                list2.Add(new SLV((FPLX)0x29, (ZYFP_LX)0, "0.00", "不征税", "不征税"));
                            }
                        }
                    }
                    else if (num2 != 0.015)
                    {
                        ...
                        list2.Add(new SLV((FPLX)0x29, (ZYFP_LX)0, num2.ToString(), str2, str2));
                    }
                }
            }
            ...
            else
            {
                ...
                if (!AutoImport.PathIsNull)
                {
                    ...
                    if (import.ShowDialog() == DialogResult.Cancel)
                    {
                        ...
                        else if ((import.CurFpdm == "0000000000") || (import.CurFphm == "00000000"))
                        {
        ...
        private void tool_dkdr_Click(object sender, EventArgs e)
        {
            ...
            if (form.ShowDialog() == DialogResult.OK)
            {
                ...
                if ((swdkFpxxRet != null) && (swdkFpxxRet.fpxx != null))
                {
                    ...
                    {
                        flag = this.fpm.CopyDjfp(fpxx, base._fpxx, false);
                    }
                    if (flag)
                    {
                        this.ResetQyxx();
                    ...
                    if (!this.tool_fushu.Checked)
                    {
                        ...
                        if (hzfptk_pp.ShowDialog() == DialogResult.OK)
                        {
                            ...
                            if (blueFpxx != null)
                            {
                                ...
                                byte[] buffer3 = AES_Crypt.Encrypt(Encoding.Unicode.GetBytes("KP" + DateTime.Now.ToString("F")), destinationArray, buffer2);
                                Invoice.IsGfSqdFp_Static=false;
                                Invoice invoice = new Invoice(true, blueFpxx, buffer3, dy_mb);
                                string str = base._fpxx.Fpdm;
                                string str2 = base._fpxx.Fphm;
                                string str3 = base._fpxx.Kprq;
                                Invoice redInvoice = invoice.GetRedInvoice(true);
                                ...
                                base.reset_fpxx(false);
                                base._ShowDataGridMxxx(base._DataGridView);
                                base._spmcBt.Visible = false;
                                if (base._DataGridView.Rows.Count > 0)
                                {
                                    base._DataGridView.Rows[0].Cells[base._DataGridView.ColumnCount - 5].Selected = true;
                                }
                                if (base._fpxx.Fplx == 0)
                                {
                                    if (base._fpxx.Zyfplx == (ZYFP_LX)1)
                                    {
                                        this.SetHysyHsjxx(base._DataGridView, true);
                                        this.prevCmbSlv = base._GetSLv(0, "0.05", 0);
                ...
                if ((objArray != null) && (objArray.Length == 3))
                {
                    ...
                    if (fp != null)
                    {
                        ...
                        else if ((fp.bmbbbh == "") || (fp.bmbbbh == null))
                        {
                            ...
                            if (new Add_SPFLBM(base._fpxx, false).ShowDialog() != DialogResult.OK)
                            {
                                this.isFPCopy = false;
                                this.RefreshData(false);
                                base._fpxx.SetQdbz(false);
        ...
        {
            new ImportSet((FPLX)0x29).ShowDialog();
        }
        ...
        private void tool_manualImport_Click(object sender, EventArgs e)
        {
            ...
            {
                string errorTip = "";
                List<Djfp> collection = new FPDJHelper().ParseDZDjFileManual(base._fpxx.Fplx, dialog.FileName, out errorTip, base._fpxx.GetSqSLv());
                ...
                {
                    ManualImport import = new ManualImport(base._fpxx.Fplx, (this.zyfplx == (ZYFP_LX)9) ? 1 : 0);
                    import.DjfpList.AddRange(collection);
                    import.AllDjfpList.AddRange(collection);
                    if (import.ShowDialog() == DialogResult.OK)
                    {
                        Djfp djfp = import.Djfp;
                        this.RefreshData(djfp.Fpxx.isRed);
                        if ((djfp != null) && (djfp.Fpxx != null))
                        {
                            bool flag = false;
                            if (djfp.Fpxx.isRed)
                            {
                                Fpxx blueFpxx = ManualImport.blueFpxx;
                                if (blueFpxx != null)
                                {
                                    this.blueJe = blueFpxx.je;
                                }
                                flag = this.FillDjxx(djfp, true);
                            }
                            else
                            {
                                flag = this.FillDjxx(djfp, false);
                            }
                            if (!flag)
                            {
                                MessageManager.ShowMsgBox(this.fpm.Code(), this.fpm.CodeParams());
        ...
        private void tool_print_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!base._onlyShow)
                {
                    ...
                    if (base._fpxx.IsRed)
                    {
                        if ((base._fpxx.Fplx == (FPLX)0x29) && !this.CheckPTHZFP())
                        {
                            return;
                        }
                ...
                if (this.isWM())
                {
                    ...
                    {
                        base._fpxx.SetLslvbs(j, "");
                        base._fpxx.SetYhsm(j, "");
                        base._fpxx.SetXsyh(j, "0");
                        base._fpxx.SetFlbm(j, "");
                        base._fpxx.SetSpbh(j, "");
                    }
                }
                else
                {
                    ...
                    {
                        if ((((list2[k][(SPXX)10] == "0") || (list2[k][(SPXX)10] == "3")) || (list2[k][(SPXX)10] == "4")) && (list2[k][(SPXX)20] == ""))
                        {
                ...
                for (int i = 0; i < spxxs.Count; i++)
                {
                    if (base.isXT(spxxs[i][0].ToString()))
                    {
                        MessageManager.ShowMsgBox("INP-242184");
                        return;
                    }
                    if (spxxs[i][(SPXX)0x15] == "0")
                    {
                ...
                {
                    if (((base._fpxx.Gfsh.Length != 15) && (base._fpxx.Gfsh.Length != 0x11)) && ((base._fpxx.Gfsh.Length != 0x12) && (base._fpxx.Gfsh.Length != 20)))
                    {
                        string[] textArray3 = new string[] { "购货单位税号" };
                        if (MessageManager.ShowMsgBox("INP-242203", textArray3) != DialogResult.Yes)
                        {
                            return;
                        }
                    }
                    if ((!base._onlyShow && base._fpxx.IsRed) && ((fpData.fplx == 0) && !this.fpm.CheckRedNum(fpData.redNum, fpData.fplx)))
                    {
                        string[] textArray4 = new string[] { fpData.redNum };
                        MessageManager.ShowMsgBox(this.fpm.Code(), textArray4);
                    }
                    else
                    {
                        string str = "Aisino.Fwkp.Invoice" + base._fpxx.Fpdm + base._fpxx.Fphm;
                        ...
                        if (base._onlyShow || base._fpxx.MakeCardInvoice(fpData, false))
                        {
                            ...
                            if (!base._onlyShow)
                            {
                                ...
                                {
                                    if ((int.Parse(base._fpxx.Fphm) == JSFPJSelect.endnum) && (new JSFPJSelect((FPLX)0x29).ShowDialog() != DialogResult.OK))
                                    {
                                        base.FormClosing -= new FormClosingEventHandler(this._InvoiceForm_FormClosing);
                                        base.Close();
                                    }
        ...
        private void tool_shezhi_Click(object sender, EventArgs e)
        {
            if (this.regeditFilePath != "")
            {
                Process.Start(this.regeditFilePath);
            }
        }
        ...
        private void UploadSwdkfp(Fpxx fp)
        {
            ...
            if (str.Trim() == "")
            {
                MessageManager.ShowMsgBox("INP-242182");
            }
            else
            {
                try
        ...
        {
            public static readonly InvoiceForm_JS.serializeClass instance = new InvoiceForm_JS.serializeClass();
            public static Func<double, double> staticFunc_1;
            public static Func<IGrouping<double, double>, double> staticFunc_2;

            internal double slvlistFunc_1(double p)
            {
                return p;
            }

            internal double slvlistFunc_2(IGrouping<double, double> p)
            {
                return p.Key;
            }
        }
