namespace Aisino.Fwkp.Fptk.Form
{
    ...
    public class InvoiceShowForm_JS : DockForm
    {
        ...
        private ILog log = LogUtil.GetLogger<InvoiceShowForm_JS>();
        ...
        internal InvoiceShowForm_JS(bool flag, int index, List<string[]> data)
        {
            this.data = data;
            this.index = index;
            ...
            this.tool_shezhi.Visible = false;
            ...
            this._DataGridView.Columns["SLV"].Visible = false;
            this.SetTitleFont();
        ...
        private SLV _GetSLv(FPLX fplx, string value, int valueType)
        {
            ...
            if (value == "中外合作油气田")
            {
                return new SLV(0, (ZYFP_LX)1, "0.05", "中外合作油气田", "中外合作油气田");
            }
            ...
            if (value == "0.015")
            {
                return new SLV(fplx, (ZYFP_LX)10, "0.015", "1.5%", "1.5%");
            }
            if (valueType != 0)
            {
                return null;
        ...
        private void _SetHzxx()
        {
            ...
            this.lab_hj_je.Text = "￥" + decimal.Subtract(decimal.Parse(this._fpxx.GetHjJeHs()), decimal.Parse(this._fpxx.GetHjSe())).ToString();
        ...
        private void Initialize()
        {
            ...
            this.tool_shezhi = this.xmlComponentLoader1.GetControlByName<ToolStripButton>("tool_shezhi");
            ...
            this.lab_jqbh = this.xmlComponentLoader1.GetControlByName<AisinoLBL>("lab_jqbh");
            ...
            this.hsjbzButton.Visible = false;
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(InvoiceShowForm_JS));
            ...
            this.xmlComponentLoader1.Size = new Size(0x224, 0x2be);
            this.xmlComponentLoader1.TabIndex = 0;
            this.xmlComponentLoader1.XMLPath=@"..\Config\Components\Aisino.Fwkp.Fpkj.Form.JSFPtiankai_new\Aisino.Fwkp.Fpkj.Form.JSFPtiankai_new.xml";
            base.AutoScaleDimensions = new SizeF(6f, 12f);
            base.AutoScaleMode = AutoScaleMode.Font;
            base.ClientSize = new Size(0x224, 0x2be);
            base.Controls.Add(this.xmlComponentLoader1);
            base.Icon = (Icon) manager.GetObject("$this.Icon");
            this.MinimumSize = new Size(550, 540);
            base.Name = "InvoiceShowForm_JS";
        ...
        private void ShowInfo(Fpxx fp, string zfbz)
        {
            ...
            this._fpxx = new Invoice(str.Equals("1"), fp, buffer3, InvoiceForm_JS.dy_mb);
            ...
            this.lab_jqbh.Text = this._fpxx.Jqbh;
        ...
        {
            public static readonly InvoiceShowForm_JS.serializeClass instance = new InvoiceShowForm_JS.serializeClass();
