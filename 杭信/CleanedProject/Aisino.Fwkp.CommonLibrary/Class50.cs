...
internal class Class50
{
    ...
    internal static void lLHifFIsCLsZtjvFfN0i()
    {
        ...
        {
            bool_0 = true;
            AppDomain.CurrentDomain.AssemblyResolve += new ResolveEventHandler(Class50.smethod_0);
        }
    }
        ...
        lock (hashtable_0)
        {
            ...
            if (obj2 == null)
            {
                try
                {
                    ...
                    string name = "b0494a1f-4bd3-" + Convert.ToBase64String(Class46.smethod_9(bytes));
                    Stream manifestResourceStream = typeof(Class50).Assembly.GetManifestResourceStream(name);
