namespace Aisino.Framework.Plugin.Core.PrintGrid
{
    ...
    public class PrintOptionsFormN : Form
    {
        private bool bool_0;
        private bool bool_1;
        private bool bool_2;
        ...
        public PrintOptionsFormN(DataGridView dataGridView_1, object object_1, string string_7, List<PrinterItems> hearder, List<PrinterItems> footer) : this(dataGridView_1, dataGridView_1.Name, object_1, string_7, hearder, footer)
        {
            
        }

        internal PrintOptionsFormN(DataGridView dataGridView_1, string string_7, object object_1, string string_8, List<PrinterItems> hearder, List<PrinterItems> footer)
        {
            ...
            try
            {
                ...
                this.string_1 = "Aisino.GridPrint.Common1.print";
            ...
            {
                this.ilog_0.Debug("PrintOptionsFormN异常：" + exception.ToString());
            }
        }
        ...
        private void btnChangePage_Click(object sender, EventArgs e)
        {
            ...
            {
                this.lblPageSize.Text = this.method_21(this.pageSetupDialog_0.PageSettings.PaperSize);
        ...
        private void btnCurReset_Click(object sender, EventArgs e)
        {
            ...
            {
                this.lblPageSize.Text = this.method_21(this.class136_1.method_30().PaperSize);
                this.lblPrintDeriction.Text = this.class136_1.method_30().Landscape ? "横向打印" : "纵向打印";
                this.pageSetupDialog_0.PageSettings = this.method_18(this.class136_1.method_30());
                ...
                this.method_20(this.class136_1, this.class136_0);
            }
            this.printDocument_0.DefaultPageSettings = this.method_18(this.class136_0.method_30());
            this.method_13();
        }
        ...
        private void btnPageSettingsPub_Click(object sender, EventArgs e)
        {
            ...
            {
                this.lblPageSizePub.Text = this.method_21(this.pageSetupDialog_1.PageSettings.PaperSize);
        ...
        {
            if (this.method_26(this.class136_0.method_30().PrinterSettings.PrinterName))
            {
                if (this.isSerialPrint)
                {
                    base.Close();
        ...
        private void btnResetPub_Click(object sender, EventArgs e)
        {
            ...
            {
                this.lblPageSizePub.Text = this.method_21(this.class137_1.method_26().PaperSize);
                this.lblPrintDerictionPub.Text = this.class137_1.method_26().Landscape ? "横向打印" : "纵向打印";
                this.pageSetupDialog_1.PageSettings = this.method_18(this.class137_1.method_26());
                ...
                this.method_19(this.class137_1, this.class137_0);
            }
        }
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(PrintOptionsFormN));
            ...
            this.groupBox2.Size = new Size(0x1e5, 0x147);
            ...
            this.btnChangePage.Size = new Size(0x4b, 30);
            ...
            this.btnCurSave.Size = new Size(0x4b, 30);
            ...
            this.btnCurReset.Size = new Size(0x4b, 30);
            ...
            this.groupBox1.Size = new Size(0x1e5, 0x147);
            ...
            this.btnView.Size = new Size(0x4b, 30);
            ...
            this.btnPrint.Size = new Size(0x4b, 30);
        ...
        private int method_0(PrintPageEventArgs printPageEventArgs_0, float float_6, float float_7, ref int int_5, float float_8, int int_6)
        {
            ...
            try
            {
                ...
                while (num3 < this.list_0.Count)
                {
                    ...
                    if ((float_6 + width) > ((((printPageEventArgs_0.MarginBounds.X * 2) + printPageEventArgs_0.MarginBounds.Width) - 30) + 1))
                    {
                        goto Label_0340;
                    }
                    switch (int_6)
        ...
        private void method_16()
        {
            try
            {
                ...
                base.Load += new EventHandler(this.PrintOptionsFormN_Load);
                base.FormClosing += new FormClosingEventHandler(this.PrintOptionsFormN_FormClosing);
            }
            catch (Exception exception)
            {
                this.ilog_0.Error("InitEvents异常：" + exception.ToString());
            }
        }
        ...
        private void method_17()
        {
            try
            {
                ...
                bool flag = false;
                string str = Path.Combine(this.string_2, this.string_1);
                flag = this.method_23(str);
                this.method_19(this.class137_0, this.class137_1);
                this.txtTitle.Text = this.class136_0.method_0();
                string str2 = Path.Combine(this.string_2, this.string_0);
                if (!this.method_25(str2) && flag)
                {
                    this.method_22();
                }
                this.method_20(this.class136_0, this.class136_1);
                this.printDocument_0.DefaultPageSettings = this.method_18(this.class136_0.method_30());
            }
            catch (Exception exception)
            {
                this.ilog_0.Error("InitControls异常：" + exception.ToString());
            }
        }

        private PageSettings method_18(PageSettings pageSettings_0)
        {
        ...
        private void method_19(Class137 class137_2, Class137 class137_3)
        {
            ...
            class137_3.method_27(this.method_18(class137_2.method_26()));
        }
        ...
        private void method_20(Class136 class136_2, Class136 class136_3)
        {
            ...
            class136_3.method_31(this.method_18(class136_2.method_30()));
        }

        private string method_21(PaperSize paperSize_0)
        {
        ...
        private void method_22()
        {
            ...
            this.lblPageSize.Text = this.method_21(this.class137_0.method_26().PaperSize);
            this.lblPrintDeriction.Text = this.class137_0.method_26().Landscape ? "横向打印" : "纵向打印";
            this.pageSetupDialog_0.PageSettings = this.method_18(this.class137_0.method_26());
            this.printDialog_0.PrinterSettings = this.pageSetupDialog_0.PrinterSettings;
            ...
            this.class136_0.method_31(this.method_18(this.class137_0.method_26()));
        }

        private bool method_23(string string_7)
        {
            bool flag = false;
            try
            {
                ...
                if ((obj2 != null) && (obj2 is Class137))
                {
                    ...
                    this.lblPageSizePub.Text = this.method_21(this.class137_0.method_26().PaperSize);
                    this.lblPrintDerictionPub.Text = this.class137_0.method_26().Landscape ? "横向打印" : "纵向打印";
                    this.pageSetupDialog_1.PageSettings = this.method_18(this.class137_0.method_26());
        ...
        private bool method_25(string string_7)
        {
            bool flag = false;
            try
            {
                ...
                if ((obj2 != null) && (obj2 is Class136))
                {
                    ...
                    if (this.method_26(this.class136_0.method_30().PrinterSettings.PrinterName))
                    {
                        this.lblPageSize.Text = this.method_21(this.class136_0.method_30().PaperSize);
                        this.lblPrintDeriction.Text = this.class136_0.method_30().Landscape ? "横向打印" : "纵向打印";
                        this.pageSetupDialog_0.PageSettings = this.method_18(this.class136_0.method_30());
        ...
        private bool method_26(string string_7)
        {
            bool flag = false;
        ...
        public bool Print(bool bool_6)
        {
            try
            {
                this.bool_2 = false;
                this.bool_5 = bool_6;
                this.ilog_0.Debug("打印标题：" + this.string_6);
                if (!bool_6)
                {
        ...
        private void printDocument_0_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            Label_01FD:
                if (this.class136_0.method_20())
                {
                    ...
                    int num16 = num6;
                    foreach (int num18 in this.list_1)
                    {
                        num17 = 0.0;
                        ...
                        if (num17 > 0.0)
                        {
                            this.dataRow_0[num18] = num17;
                        }
                    }
                    foreach (int num20 in this.list_1)
                    {
                        num17 = 0.0;
        ...
        private void PrintOptionsFormN_FormClosing(object sender, EventArgs e)
        {
            if (this.isSerialPrint)
            {
                this.method_28();
        ...
        private void PrintOptionsFormN_Load(object sender, EventArgs e)
        {
        }
