namespace Aisino.Fwkp.Fplygl.Entry.WebModualEntry
{
    ...
    public sealed class Apply_SuccessConfirmEntry : AbstractCommand
    {
        private ILog loger = LogUtil.GetLogger<Apply_SuccessConfirmEntry>();
        ...
        protected override void RunCommand()
        {
            try
            {
                ...
                ApplySuccessConfirm confirm = new ApplySuccessConfirm(out dataExist);
                if (dataExist)
                {
                    confirm.ShowDialog();
                }
